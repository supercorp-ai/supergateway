...
- **`--protocolVersion "2025-06-18"`**: Protocol version the gateway uses when it initializes the server itself (stateless stdio→Streamable HTTP mode, default: `2024-11-05`)
