...
const response = await fetch(
  'https://registry.npmjs.org/supergateway/-/supergateway-4.0.0-rc.0.tgz',
...
assert.equal(
  ...
  'cc4c5315a302aaa5dfed3492eb5ce78054bceb0361443dd0167fc309aeb0c492',
)
const tarball = resolve(root, 'supergateway-4.0.0-rc.0.tgz')
